...
def plot_stcok_k_chart(IMGUR_CLIENT_ID,stock="0050" , date_from='2023-01-01' ):
    """
    進行個股K線繪製，回傳至於雲端圖床的連結。將顯示包含5MA、20MA及量價關係，起始預設自2023-01-01起迄昨日收盤價。
...
def handle_message(event):
    if event.source.user_id =='U03c641f73d89933c2580b5c5a96ed50e':
        return 'OK'
